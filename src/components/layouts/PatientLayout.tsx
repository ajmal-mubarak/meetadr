        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3.5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-teal-500 to-teal-700 text-white flex items-center justify-center font-black text-lg shadow-sm shadow-teal-600/20 ring-4 ring-teal-50">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  {user?.email || 'patient@meetadr.demo'} • Health ID: #PT-8429
                </p>
              </div>
            </div>
          ...
          <div className="mt-6 flex items-center justify-between border-t border-slate-100 pt-1 flex-wrap gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-rose-600 hover:text-rose-700 hover:bg-rose-50 transition-colors cursor-pointer ml-auto"
            >
