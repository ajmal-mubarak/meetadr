        ...
        {doctors.map((doc) => (
          ...
          >
            <div>
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <span className="text-xs font-semibold text-[#0E7490] block">
                    {doc.specialty}
                  </span>
            ...
            <div className="mt-4 pt-3 border-t border-[#E2EBF0] flex items-center justify-between text-xs text-slate-500">
              ...
              <span className="font-semibold text-[#0E7490] bg-[#E8F6F8] px-2.5 py-0.5 rounded-md border border-[#CDEBF0]">{doc.availableSlots.length} Slots/Day</span>
            </div>
          </div>
        ))}
      </div>
          ...
          <div className="w-full max-w-xl bg-white rounded-3xl p-6 sm:p-8 shadow-2xl border border-[#E2EBF0] max-h-[90vh] overflow-y-auto space-y-6">
            ...
            <form onSubmit={handleAddDoctor} className="space-y-4">
              ...
              <div className="pt-3 border-t border-[#E2EBF0] flex items-center justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-[#2DA7B5] hover:bg-[#23929F] text-white text-xs font-bold rounded-xl shadow-xs transition-colors cursor-pointer"
                >
                  Save Doctor
                </button>
              </div>
