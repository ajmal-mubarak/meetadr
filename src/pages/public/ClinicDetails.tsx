  ...
  if (isLoading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center">
        ...
        <p className="text-sm text-slate-500">Loading clinic profile...</p>
      </div>
    );
  }
  ...
  if (!clinic) {
    return (
      <div className="max-w-2xl mx-auto py-16 px-4 text-center">
        <h2 className="text-xl font-bold text-slate-900 mb-2">Clinic Not Found</h2>
        <Link
          to="/clinics"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-900 mb-4">
            Practicing Specialists at {clinic.name}
          </h2>

          {doctors.length === 0 ? (
            <div className="bg-white p-6 rounded-2xl border border-slate-200 text-center text-sm text-slate-500">
              No specific doctors currently listed for online scheduling at this clinic.
            </div>
          ) : (
