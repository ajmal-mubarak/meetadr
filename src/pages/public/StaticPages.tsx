...
export const AboutPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#081217] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-8">
        <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4">
          <div className="p-5 rounded-2xl bg-[#081217] border border-slate-800">
          ...
          <div className="p-5 rounded-2xl bg-[#081217] border border-slate-800">
            <Shield className="w-6 h-6 text-slate-300 mb-2" />
            <h3 className="font-bold text-white text-sm">
          ...
          <div className="p-5 rounded-2xl bg-[#081217] border border-slate-800">
            <HeartHandshake className="w-6 h-6 text-slate-300 mb-2" />
            <h3 className="font-bold text-white text-sm">
        ...
        <div className="space-y-4 pt-4 border-t border-slate-800 text-sm text-slate-300 leading-relaxed">
    ...
    <div className="bg-[#081217] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl bg-[#081217] border border-slate-800 space-y-2">
      ...
      <div className="max-w-4xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4">
          {[
            ...
            <div key={partner} className="p-4 rounded-xl border border-slate-800 bg-[#081217] flex items-center justify-center text-center">
              <span className="text-xs font-bold text-slate-200">{partner}</span>
            </div>
          ))}
        </div>

        <div className="bg-[#081217] p-6 rounded-2xl border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="font-bold text-white text-sm">
          ...
          <Link
            to="/join"
            className="px-5 py-2.5 bg-[#007B8A] hover:bg-[#00606B] text-white font-bold text-xs rounded-xl border border-[#005F6B] shrink-0 transition-all"
          >
    ...
    <div className="bg-[#081217] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-5 rounded-2xl bg-[#081217] border border-slate-800 text-xs text-slate-300 space-y-1">
            <Phone className="w-5 h-5 text-slate-300 mb-2" />
            <strong className="block text-white font-semibold text-sm">
              {isArabic ? 'الدعم الهاتفي' : 'Phone Support'}
            </strong>
            <span dir="ltr" className="inline-block font-mono font-bold text-slate-200">+971 52 412 2794</span>
          ...
          <div className="p-5 rounded-2xl bg-[#081217] border border-slate-800 text-xs text-slate-300 space-y-1">
            <Mail className="w-5 h-5 text-slate-300 mb-2" />
            <strong className="block text-white font-semibold text-sm">
              {isArabic ? 'البريد الإلكتروني' : 'Email Inquiries'}
            </strong>
            <span dir="ltr" className="inline-block font-mono text-slate-200">info@meetadr.com</span>
            <span className="block text-slate-400">
          ...
          <div className="p-5 rounded-2xl bg-[#081217] border border-slate-800 text-xs text-slate-300 space-y-1">
            <MapPin className="w-5 h-5 text-slate-300 mb-2" />
            <strong className="block text-white font-semibold text-sm">
              {isArabic ? 'المقر الرئيسي' : 'Headquarters'}
            </strong>
            <span>{isArabic ? 'مدينة دبي الطبية' : 'Dubai Healthcare City'}</span>
            <span className="block text-slate-400">
        ...
        {submitted ? (
          <div className="p-6 bg-[#081217] rounded-2xl border border-slate-800 text-center space-y-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-4 border-t border-slate-800">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 border border-slate-800 bg-[#081217] text-white rounded-xl text-sm focus:border-slate-500 focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-2.5 border border-slate-800 bg-[#081217] text-white rounded-xl text-sm focus:border-slate-500 focus:outline-none resize-none"
              />
            </div>

            <button
              type="submit"
              className="px-6 py-2.5 bg-[#007B8A] hover:bg-[#00606B] text-white font-bold text-sm rounded-xl border border-[#005F6B] transition-all cursor-pointer"
            >
...
export const FaqPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#081217] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-6">
        <div>
          <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">
        ...
        <div className="space-y-4 pt-2">
          {faqs.map((faq, i) => (
            <div key={i} className="p-4 rounded-xl border border-slate-800 bg-[#081217] space-y-2">
  ...
  return (
    <div className="bg-[#081217] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-6">
        ...
        <div className="p-6 rounded-2xl bg-[#081217] border border-slate-800 text-xs text-slate-200 space-y-2">
          ...
          <p className="flex items-center gap-2">
            ...
            <strong dir="ltr" className="font-mono text-sm text-white">+971 52 412 2794</strong>
          </p>
          <p className="flex items-center gap-2">
            <span>{isArabic ? 'البريد الإلكتروني:' : 'Email:'}</span>
            <strong dir="ltr" className="font-mono text-white">info@meetadr.com</strong>
          </p>
        </div>
      </div>
    </div>
...
export const PrivacyPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#081217] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-6 text-slate-300 text-sm leading-relaxed">
        <div>
          <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">
...
export const AccessibilityPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#081217] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-6 text-slate-300 text-sm leading-relaxed">
        <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">
  ...
  return (
    <div className="bg-[#081217] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-6">
        ...
        <div className="p-6 rounded-2xl bg-[#081217] border border-slate-800 text-xs text-slate-300 space-y-2">
          <strong className="block text-sm font-bold text-white">
          ...
          <p>
            ...
            <strong dir="ltr" className="font-mono text-slate-200">careers@meetadr.com</strong>.
          </p>
        </div>
      </div>
    </div>
...
export const ReferPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#081217] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-[#0C1A22] rounded-3xl border border-slate-800 p-8 sm:p-12 space-y-6 text-center">
        <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">
        ...
        <div className="max-w-md mx-auto flex items-center gap-2 p-2 bg-[#081217] border border-slate-800 rounded-2xl">
          <input
            type="text"
            readOnly
          ...
          <button
            onClick={handleCopy}
            className="px-4 py-2 bg-[#007B8A] hover:bg-[#00606B] text-white rounded-xl text-xs font-bold transition-all border border-[#005F6B] cursor-pointer"
          >
