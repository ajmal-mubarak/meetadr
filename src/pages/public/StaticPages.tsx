    ...
    <div className="bg-slate-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-3xl border border-slate-200 p-8 sm:p-12 shadow-xs space-y-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4">
          {[
            isArabic ? 'مستشفى كليمنصو الطبي دبي' : 'Clemenceau Medical Center Dubai',
            isArabic ? 'مستشفى ميدكير الصفا' : 'Medcare Hospital Al Safa',
            isArabic ? 'المستشفى الكندي التخصصي' : 'Canadian Specialist Hospital',
            isArabic ? 'مستشفى أستر المنخول' : 'Aster Hospital Mankhool',
            isArabic ? 'مجموعة سيتي كير الصحية' : 'City Care Health Group',
            isArabic ? 'مجمع النور الطبي' : 'Al Noor Hospital Trust',
            isArabic ? 'عيادات الخليج المركزية' : 'Gulf Central Clinics',
            isArabic ? 'مستشفى الشارقة الأكاديمي' : 'Sharjah Academic Hospital',
          ].map((partner) => (
        ...
        <div className="bg-teal-50 p-6 rounded-2xl border border-teal-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="font-bold text-slate-900 text-sm">
          ...
          <Link
            to="/join"
            className="px-5 py-2.5 bg-teal-600 hover:bg-teal-700 text-white font-semibold text-xs rounded-xl shadow-xs shrink-0"
          >
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-3xl border border-slate-200 p-8 sm:p-12 shadow-xs space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 text-xs text-slate-600 space-y-1">
            <Phone className="w-5 h-5 text-teal-600 mb-2" />
          ...
          <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 text-xs text-slate-600 space-y-1">
            ...
            <span dir="ltr" className="inline-block font-mono text-slate-800">info@meetadr.com</span>
            <span className="block text-slate-400">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-4 border-t border-slate-100">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 bg-teal-600 hover:bg-teal-700 text-white font-semibold text-sm rounded-xl transition-colors shadow-xs cursor-pointer"
            >
  ...
  return (
    <div className="bg-slate-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-3xl border border-slate-200 p-8 sm:p-12 shadow-xs space-y-6">
        ...
        <div className="p-6 rounded-2xl bg-teal-50 border border-teal-200 text-xs text-teal-950 space-y-2">
          <strong className="block text-sm font-bold">
            {isArabic ? 'خط مساعدة المرضى المباشر' : '24/7 Patient Helpline'}
          </strong>
          <p className="flex items-center gap-2">
            <span>{isArabic ? 'الهاتف المباشر:' : 'Direct Phone:'}</span>
            <strong dir="ltr" className="font-mono text-sm">+971 52 412 2794</strong>
          </p>
          <p className="flex items-center gap-2">
            <span>{isArabic ? 'البريد الإلكتروني:' : 'Email:'}</span>
            <strong dir="ltr" className="font-mono">info@meetadr.com</strong>
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-3xl border border-slate-200 p-8 sm:p-12 shadow-xs space-y-6">
        ...
        <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 text-xs text-slate-600 space-y-2">
          ...
          <p>
            ...
            <strong dir="ltr" className="font-mono">careers@meetadr.com</strong>.
          </p>
        </div>
      </div>
    </div>
